...
\begin{frame}{Overview of the work}
	\begin{itemize}
		\item Bodhi-class
		\begin{itemize}
			\item {\color{red}Marks for offline exams (Stage I)}
			\item {\color{blue}Archiving emails
			\item Facebook style notifications
			\item Miscellaneous}
			\begin{itemize}
				\item {\color{blue}In-video quizzes ON/OFF
		...
		\item Bodhi-book
		\begin{itemize}
			\item {\color{blue}Prerequisites and course graph}
			\item {\color{red}Access control (Stage I, {\color{blue}Modified in Stage II})}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\subsection{Marks for offline examinations (Stage I)}

\begin{frame}{Marks for offline examinations}{Stage I work}
